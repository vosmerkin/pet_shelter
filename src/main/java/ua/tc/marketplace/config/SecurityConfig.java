        ...
        .authorizeHttpRequests(
            config ->
                config
                    ...
                    .permitAll()
                    .requestMatchers(HttpMethod.POST, AUTH_BASE + AUTH_SIGNUP_WITH_VERIFY)
                    .permitAll()
                    .requestMatchers(HttpMethod.POST, SAMPLE_DATA_BASE + SAMPLE_DATA_ADD_ADS)
                    .permitAll()
                    .requestMatchers(HttpMethod.PUT, AUTH_BASE + AUTH_RESET_PASSWORD)
                    .permitAll()
                    //                                        .requestMatchers(HttpMethod.POST,
                    // "/api/v1/ad").authenticated()
                    .requestMatchers(
                        HttpMethod.GET,
                        //
