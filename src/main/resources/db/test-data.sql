...
VALUES (1, 'Beautiful dog searching a kind family',
        'This lovely dog is looking for a caring home. Friendly and playful.', 100.00, null, 1,
        NOW(),
        NOW()),
       ...
       (3, 'Friendly rabbit available for adoption',
        'Cute rabbit ready for adoption. Gentle and easy to care for.', 300.00, null, 3, NOW(),
        NOW()),
